...
// Konfigurasi Database (Mendukung define constant maupun variabel biasa)
...
if (!defined('ORIGIN_POSTAL_CODE')) define('ORIGIN_POSTAL_CODE', 65111);
if (!defined('ORIGIN_CITY')) define('ORIGIN_CITY', 'Malang');
if (!defined('ORIGIN_PROVINCE')) define('ORIGIN_PROVINCE', 'Jawa Timur');
